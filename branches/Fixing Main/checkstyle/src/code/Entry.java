...
public class Entry {
	...
	/** <h1> Constructor for float number input entries.</h1>
	...
	/** <h1> Constructor for a Symbol type character input entries.</h1>
	 * {@summary initializing the type and value of entry}
	 * @exception avoid all kinds of exceptions and errors
	...
	//hash code and equals method, generated at 06/11/2019
	@Override
	public int hashCode() {
