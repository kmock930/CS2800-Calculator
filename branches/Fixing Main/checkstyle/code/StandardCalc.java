...
/**
 * StandardCalc.
 * {@summary handling infix notation expressions.}
 * @author Kelvin
 */
public class StandardCalc {
  ...
  /**
   * StandardCalc.
   * {@summary constructor to initialize stacks and variables.}
   */
  public StandardCalc() {
  ...
  /**
   * evaluate.
   * {@summary evaluate infix expressions.}
   * @paramstring
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(result, revExpr, rpCalc, str, values);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Float.floatToIntBits(result) == Float.floatToIntBits(other.result)
      && Objects.equals(revExpr, other.revExpr)
